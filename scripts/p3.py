...
# Load dataset
df = pd.read_csv(os.path.join(DATA_DIR, "lungcancer.csv"))
...
joblib.dump(rf, os.path.join(MODELS_DIR, "lungcancer_rf_model.pkl"))
joblib.dump(log_reg, os.path.join(MODELS_DIR, "lungcancer_logreg_model.pkl"))
joblib.dump(scaler, os.path.join(MODELS_DIR, "lungcancer_scaler.pkl"))
joblib.dump(X.columns, os.path.join(MODELS_DIR, "lungcancer_features.pkl"))
