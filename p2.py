...
def load_diabetes_model():
    ...
    try:
        ...
        encoders_path = os.path.join(MODELS_DIR, 'diabetes_encoders.pkl')
...
add_bg_from_local(os.path.join(STATIC_DIR, "bg.png"))
...
def load_diabetes_model():
    try:
        with open(os.path.join(MODELS_DIR, 'diabetes_model.pkl'), 'rb') as f:
            model = pickle.load(f)
        with open(os.path.join(MODELS_DIR, 'diabetes_encoders.pkl'), 'rb') as f:
...
# ====================== MODE SELECTION ======================
    ...
    with col1:
        st.image(os.path.join(STATIC_DIR, "diagnosis_mode_icon.png"), width=180)
    ...
    with col2:
        st.image(os.path.join(STATIC_DIR, "training_mode_icon.png"), width=180)
