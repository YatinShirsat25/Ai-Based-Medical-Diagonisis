...
├── scripts/                            # Training / utility scripts (p1.py, p3.py)
├── p2.py                               # Streamlit prototype script
...
There are example Python scripts in `scripts/` and `p2.py` in the project root. To run an example:
...
* `data/bp.csv`, `data/bp_awareness_dataset_6000.csv` — blood pressure data
* `data/diabetes.csv` — diabetes dataset
* `data/lungcancer.csv` — lung cancer dataset
* `data/disease_mcq_dataset_500.csv` — MCQ set for training / quizzes
